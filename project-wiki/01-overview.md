...
> **🔴 第一原则**：**Lluren Wiki 是「你的个人知识分身」**——沉淀并调用**你自己的**知识、经验、经历、
> 生活的平台。它是**向内**的（把你的私人语料变成可对话、可检索的第二大脑），**不是**向外做联网深度
> 研究的工具。任何"向外扩张/联网研究"性质的功能（如已删除的 Deep Research）**都不属于本平台方向**；
> 从上游合并时不要把这类功能合回来。详见 [README 平台定位红线](README.md)。
